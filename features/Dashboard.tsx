      ...
      <div className="stat-grid">
        ...
        <div className="stat-card stat-amber">
          ...
          <div>
            ...
            <p className="stat-value">GH₵ {outstandingBalance.toFixed(2)}</p>
          </div>
        </div>
        <div className="stat-card stat-forest">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '20px' }}>
        ...
        <div className="card">
          ...
          {upcomingEvents.length > 0 ? (
              ...
              {upcomingEvents.map(event => (
                <div key={event.id} className="event-list-item">
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <span className={`badge ${event.type === 'Exam' ? 'badge-red' : event.type === 'Holiday' ? 'badge-amber' : 'badge-forest'}`}>
                      {event.type}
                    </span>
                  </div>
                </div>
            ...
            <p className="text-muted" style={{ textAlign: 'center', padding: '24px 0' }}>No upcoming events scheduled.</p>
          )}
        </div>
        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            ...
            <button className="quick-action" onClick={() => handleQuickAction('Fees')}>
              <span className="quick-action-icon qa-purple">
                <CreditCardIcon />
              </span>
